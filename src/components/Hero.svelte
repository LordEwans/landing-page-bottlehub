	...
	<div class="hero-content max-w-full w-full">
		<div class="text-center flex justify-center">
			<div class="md:max-w-2xl lg:max-w-6xl">
				<h1 class="text-2xl mb-2 lg:mb-4 md:text-[clamp(2rem,4vw,4.2rem)] leading-[1.1] capitalize">
					Unparalleled competitive gambling
				</h1>
				<h2 class="capitalize text-2xl md:text-[clamp(2.7rem,4vw,4rem)] font-extrabold">
				...
				<div class="">
					...
					>
					<a href="https://medium.com/" target="_blank" class="btn lg:btn-lg btn-ghost">Learn More</a>
				</div>
			</div>
		</div>
	</div>
