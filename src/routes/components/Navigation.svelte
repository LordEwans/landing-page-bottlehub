...
<div class="drawer drawer-end">
	...
	<div class="drawer-side z-10 lg:hidden">
		...
		<ul class="menu p-4 w-72 md:w-80 min-h-full bg-slate-900 text-base-content hover:bg-slate-800">
			<li class="partials">
				<a href="#features" class="partials">Features</a>
			</li>
			<li class="partials">
...
<style lang="postcss">
	...
	.partials {
		@apply inline-block uppercase font-bold text-xs text-[hsl(var(--p))];
	}
	.btn {
		@apply rounded-2xl;
	}
